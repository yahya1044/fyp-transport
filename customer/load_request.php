...
$cus_contact=$_SESSION['cus_contact'];
 ...
 <div class="container-fluid">
								...
								<span class="color_orange">   List Of  Loads Requested</span></h2>
                                ...
                                <div class="col-lg-9 col-sm-9">
								  <header class="tab_board_header GridHeading-font btn-font">
                                    <ul class="nav">
                                        <li>
                                            <a class="pull-left ">List Of Loads Requested</a>
...
<td>Status</td>
 ...
 <?php
$select="SELECT * FROM loading WHERE status='Waiting' && cus_contact='$cus_contact'";
