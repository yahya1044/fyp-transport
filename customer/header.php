                    ...
                    <div id="top-menu" class="nav">
                        <ul id="Margin-Top" class="top-breadcrumb topHeader-menu header-link">
                            ...
                            <li id="ucHeader_liLogin" class="disable-hover">
                                ...
                                <a href="Logout.php"  class="btn-login btn-danger-login btn-sm-home" title="Login on TruckSuvidha"><i id="fa-login-mobile" class="fa fa-sign-in"></i>Log Out</a>
                            </li>
                ...
                <nav class="navbar navbar-default" role="navigation">
                    ...
                    <div id="bs-example-navbar-collapse-1" class="horizontal-menu collapse navbar-collapse">
                        ...
                        <ul id="ucHeader_ulWebsiteMenu" class="nav navbar-nav scroll-mar-top">
						   ...
						   <li><a id="directory" href='../index.php' title="View the details of transporters & Packers and Movers">Post Load</a>
						   </li>
						   
						   
						   <li><a id="directory" href='packages.php' title="View the details of transporters & Packers and Movers">Packages</a>
						   </li>
						   
						   <li><a id="directory" href='truck.php' title="View the details of transporters & Packers and Movers">Trucks</a></li>
						   
						    <li><a id="directory" href='load_request.php' title="View the details of transporters & Packers and Movers">Pending Request</a>
						   </li>
						   
						    <li><a id="directory" href='current_booking.php' title="View the details of transporters & Packers and Movers">Current Booking</a>
						   </li>
						   
						   <li><a id="directory" href='previous_booking.php' title="View the details of transporters & Packers and Movers">History</a>
						   </li>
						  <li><a id="directory" href='contact.php' title="View the details of transporters & Packers and Movers">Contact Admin</a>
						   </li>
                            ...
                            <div id="ucHeader_pnlSearch" class="custom_search navbar-form" onkeypress="javascript:return WebForm_FireDefaultButton(event, &#39;ucHeader_imgBtnSearch&#39;)">
                                ...
                                <input type="image" name="ucHeader$imgBtnSearch" id="ucHeader_imgBtnSearch" class="btn custom_button img-responsive scroll-btn-img mobile-btn-bg" src="../images/Search.jpg" alt="Truck Suvidha" onclick="return CustomGoogleSearch();" />
                                <script>
